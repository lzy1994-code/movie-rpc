package com.bw.movie.cache;


import com.bw.movie.utils.PropertiesUtil;
...
public class RedisUtil {
    ...
    private static RedisPool createRedisPool(String poolName, Properties pro) {
        ...
        int maxWait = Util.convert(pro.getProperty(poolName + ".redis.pool.maxWait"), 0);
        int maxActive = Util.convert(pro.getProperty(poolName + ".redis.pool.maxActive"), 0);
        int maxIdle = Util.convert(pro.getProperty(poolName + ".redis.pool.maxIdle"), 0);
